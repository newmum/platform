...
public class Constants {
    ...
    public static final int DELETE_TEMPLATE_BY_ID = 10;

    public static String[] classSQL = new String[]{"_gen_selectById", "_gen_selectByTemplate",
            "_gen_selectCountByTemplate", "_gen_delById", "_gen_selectAll", "_gen_updateAll", "_gen_updateById",
            "_gen_updateTemplateById", "_gen_insert", "_gen_insertTemplate", "_gen_deleteTemplateById"};
