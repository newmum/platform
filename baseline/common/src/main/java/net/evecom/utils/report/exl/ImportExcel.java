package net.evecom.utils.report.exl;
...
import net.evecom.utils.object.ReflectUtils;
			...
			if (cell != null) {
				if (cell.getCellType() == Cell.CELL_TYPE_NUMERIC) {
					if (isCellDateFormatted(cell)){
						val= DTUtil.dateToString(cell.getDateCellValue());
					}else{
