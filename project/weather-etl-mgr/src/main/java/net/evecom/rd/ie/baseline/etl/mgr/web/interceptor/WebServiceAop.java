package net.evecom.rd.ie.baseline.etl.mgr.web.interceptor;
...
public class WebServiceAop {
	...
	private final String POINT_CUT = "execution(* net.evecom.processor.transform.handle.*.*(..))";
	...
	public Object doAroundAdvice(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
		...
		System.out.println(">>>环绕通知的逻辑类：" + proceedingJoinPoint.getTarget().getClass().getName()+"."+proceedingJoinPoint.getSignature().getName() + "耗时" + (end - begin));
		return obj;
	}
