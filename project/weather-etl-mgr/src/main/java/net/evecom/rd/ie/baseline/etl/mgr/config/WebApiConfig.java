...
public class WebApiConfig {
	...
	public Docket mgrApi() {
		return new Docket(DocumentationType.SWAGGER_2).groupName("综合监控API").useDefaultResponseMessages(false)
				.apiInfo(new ApiInfoBuilder().version("1.0.0").title("综合监控API").description("综合监控API").build()).select()
